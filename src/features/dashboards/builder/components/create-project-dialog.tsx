                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Enter a location name (e.g., "Gweru, Zimbabwe") and the map will automatically navigate to it, or click on the map below to pin-point the exact location
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className='py-2'>
                            <LocationPicker
                                ...
                                searchLocation={form.watch('location')}
                            />
                        </div>
