            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-6 border-b border-gray-200">
                <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1 font-medium">DIT Dashboard - The Guided Co-Pilot</p>
                    </div>
                </div>
                <div className="flex gap-2">
                    <Badge variant="outline" className="bg-gradient-to-r from-indigo-50 to-indigo-100 text-indigo-800 border-indigo-300 shadow-sm px-3 py-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="group p-6 rounded-xl bg-gradient-to-br from-white to-gray-50 border border-gray-200 shadow-sm hover:shadow-lg hover:border-indigo-300 transition-all duration-200">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-7 px-2.5 text-xs text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-md"
                ...
                <div className="space-y-6">
                    {/* Consultant Card */}
                    <div className="p-5 rounded-xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-indigo-100/50 shadow-sm hover:shadow-md transition-shadow">
                        <h3 className="font-semibold text-indigo-900 mb-4 text-base">Your Consultant</h3>
                        <div className="flex items-center gap-3 mb-4">
                            <div className="h-12 w-12 rounded-full bg-indigo-200 flex items-center justify-center text-indigo-700 font-bold text-lg shadow-sm">
                                JD
                            </div>
                            <div>
                                <div className="font-semibold text-sm text-gray-900">John Doe</div>
                                <div className="text-xs text-gray-600">Senior QS</div>
                            </div>
                        </div>
                        <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg h-10 shadow-sm">
