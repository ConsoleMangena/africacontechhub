...
// Production materials tuned for high visibility on light backgrounds.
// Indices: 0 = Wall/Trim, 1 = Deck, 2 = Interior, 3 = Shingle
export const roofMaterials: THREE.Material[] = [
  new THREE.MeshStandardMaterial({ color: '#374151', roughness: 1, side: THREE.DoubleSide }), // 0: Wall/Trim
  new THREE.MeshStandardMaterial({ color: '#4b5563', roughness: 1, side: THREE.FrontSide }), // 1: Deck
  new THREE.MeshStandardMaterial({ color: '#374151', roughness: 1, side: THREE.DoubleSide }), // 2: Interior
  new THREE.MeshStandardMaterial({ color: '#111827', roughness: 0.9, side: THREE.FrontSide }), // 3: Shingle
]
