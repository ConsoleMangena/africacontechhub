  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        />
        <Button className='mt-2 w-full h-10' disabled={isLoading}>
          {isLoading ? <Icon name="progress_activity" size={18} className='animate-spin' /> : <Icon name="login" size={18} />}
        ...
        <div className='grid grid-cols-1 gap-2'>
          <Button variant='outline' type='button' disabled={isLoading} onClick={handleGoogleLogin} className="h-10 w-full">
