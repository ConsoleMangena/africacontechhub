...
const formSchema = z
  .object({
    ...
    role: z.enum(['BUILDER', 'CONTRACTOR', 'SUPPLIER']),
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (authData.session) {
        ...
        // The role is already in user_metadata from sign-up
        // Just wait a moment for the backend to sync, then login
        await new Promise(resolve => setTimeout(resolve, 500));

        await auth.login();
        toast.success('Registration successful! Welcome to Africa ConTech Hub');
    ...
    return (
      <div className="text-center p-6">
        ...
        <p className="text-gray-600">
          We've sent a confirmation link to {form.getValues('email')}.<br />
