        ...
        <div className="w-full max-w-7xl mx-auto space-y-6">
            <div className="flex items-center gap-2 mb-4">
                <div className="h-8 w-8 rounded-lg bg-indigo-50 flex items-center justify-center">
                    <Icon name="group" className="h-4 w-4 text-indigo-600" />
                </div>
                <div>
                    ...
                    <Card className="border-border/60 bg-card">
                        <CardHeader className="pb-3">
                            <CardTitle className="text-sm font-semibold font-display flex items-center gap-2 text-foreground">
                                <Icon name="notifications" className="h-4 w-4 text-amber-600" />
                                Account Requests
                            </CardTitle>
                ...
                <div className="lg:col-span-1">
                    ...
                    <Card className="border-border/60 bg-card sticky top-36">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-semibold font-display flex items-center gap-2 text-foreground">
                                <Icon name="pie_chart" className="h-4 w-4 text-purple-600" />
                                User Distribution
                            </CardTitle>
