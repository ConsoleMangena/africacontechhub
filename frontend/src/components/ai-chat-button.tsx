                  ...
                  sessions.map(s => (
                    <div key={s.id} className="flex items-center group">
                      <button
                        ...
                        className={`flex-1 text-left px-2.5 py-1.5 rounded-md text-[11px] truncate transition-colors ${s.id === sessionId
                        ...
                        <div className="flex flex-col gap-2 text-xs text-gray-600 min-w-[260px] max-w-[340px]">
                          ...
                          <div className="flex flex-wrap gap-1 ml-6 mt-1">
                            {([
                              ...
                              return (
                                <span key={s.key} className={`text-[8px] px-1.5 py-0.5 rounded-full transition-all ${isActive ? (isScanningPlan ? 'bg-cyan-100 text-cyan-700 font-bold ring-1 ring-cyan-300' : 'bg-indigo-100 text-indigo-700 font-bold ring-1 ring-indigo-300') :
                        ...
                        <div className="flex flex-col gap-2 text-xs text-gray-600 min-w-[260px] max-w-[340px]">
                          ...
                          <div className="flex flex-wrap gap-1 ml-6 mt-1">
                            {([
                              ...
                              const isComplete = currentIdx > stepIdx
                              return (
                                <span key={s.key} className={`text-[8px] px-1.5 py-0.5 rounded-full transition-all ${isActive ? 'bg-emerald-100 text-emerald-700 font-bold ring-1 ring-emerald-300' :
